          ...
          <div className='grid sm:grid-cols-2 lg:col-span-2'>
            <div className='pl-10 pb-10'>
              ...
              <ol className='text-white '>
                ...
                <li>
                  <h5 className='text-[#ff8a00] font-MorabbaMedium'>جمعه تعطیل</h5>
                </li>
              </ol>
            </div>
            <div className=''>
              ...
              <div className='flex pb-4 gap-2 items-center'>
                ...
                <div>
                  <h5 className='text-gold-100'>آدرس:</h5>
                  <p className='text-white max-w-56'>سیرجان، خ ولی عصر، خ بدر شمالی، نبش کوچه دوم</p>
                </div>
              </div>
              <div className='flex gap-2 items-center'>
                ...
                <div>
                  <h5 className='text-gold-100'>تلفن:</h5>
                  <p className='text-white'>09134784608</p>
                </div>
              </div>
            </div>
          </div>
