    ...
    <>
      ...
      <div className="bg-blackCus-100 mt-[360px] sm:mt-[550px] lg:mt-[770px] pb-10 relative">
        <div id="header" className="mb-10 relative container">
          <h1 className="text-4xl lg:text-6xl font-MorabbaBold text-white -top-24 lg:-top-[400px] relative">
            کافه آروماتیکا
          </h1>
          <h4 className="text-gold-100 font-MorabbaMedium text-lg lg:text-center">
          ...
          <div className="bg-black w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              <div className="p-4 flex">
                ...
                <div className="pr-4 w-full flex flex-col justify-between">
                  <div>
                    <h5 className="text-white mb-0.5">چای</h5>
                    <p className="text-white/60 text-sm">
                      چای ایرانی
                    </p>
                  </div>
            ...
            <div>
              <div className="p-4 flex">
                ...
                <div className="pr-4 w-full flex flex-col justify-between">
                  <div>
                    <h5 className="text-white mb-0.5">چای سبز</h5>
                    <p className="text-white/60 text-sm">
                      چای سبز
                    </p>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gold-100">..........</span>
                    <p className="text-gold-100">55 هزار تومان</p>
                  </div>
                </div>
              </div>
              <hr className="mx-4 opacity-20 lg:hidden" />
            ...
            <div>
              <div className="p-4 flex">
                ...
                <div className="pr-4 w-full flex flex-col justify-between">
                  <div>
                    <h5 className="text-white mb-0.5">چای ترش</h5>
                    <p className="text-white/60 text-sm">
                      چای ترش
                    </p>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gold-100">..........</span>
                    <p className="text-gold-100">60 هزار تومان</p>
                  </div>
                </div>
              </div>
              <hr className="mx-4 opacity-20 hidden" />
            </div>
          </div>
        </div>
        ...
        <div id="lunch" className="container">
          <h4 className="text-gold-100 font-MorabbaMedium text-lg py-10 pb-0 lg:text-center">
            بهترین ها را انتخاب کنید
          </h4>
          <h2 className="text-white text-3xl font-MorabbaMedium py-10 pt-0 lg:text-center">
            منو ناهار آروماتیکا
              ...
              <div className="p-4 flex">
                ...
                <div className="pr-4 w-full flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-white/60 text-sm">
                      ران مرغ + ارد سوخاری + سیب سرخ کرده
                    </p>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gold-100">..........</span>
